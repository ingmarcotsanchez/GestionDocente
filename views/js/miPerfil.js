...
$(document).ready(function(){
    $.post("/GestionDocente/controller/usuario.php?opc=mostrar", { usu_id : usu_id }, function (data) {
...
$(document).on("click","#btnactualizar", function(){
    ...
    if (pass.length == 0 || newpass.length == 0) {
        ...
        if (pass==newpass){
            var usu_id = $('#usu_idx').val();
            $.post("/GestionDocente/controller/usuario.php?opc=editPerfil", {usu_id:usu_id,usu_pass:newpass}, function (data) {
                Swal.fire({
                    title: 'Correcto!',
