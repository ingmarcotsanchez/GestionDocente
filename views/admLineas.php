...
<head>
  ...
  ?>
  <title>Gestión Docente | Líneas</title>
</head>
...
<!-- Site wrapper -->
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Admón Líneas de Acción Plan Desarrollo Profesoral</h3>
                        </div>
                        <div class="card-body">
                            ...
                            <table id="linea_data" class="table display responsive wrap">
                                <thead>
                                    <tr>
                                        <th>Líneas de acción plan de desarrollo profesoral</th>
                                        <th>Estado</th>
                                        <th></th>
                                        <th></th>
                                    </tr>
    ...
    <!-- /.Site warapper -->
    <?php require_once("admLineasModal.php"); ?>
